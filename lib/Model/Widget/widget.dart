...
import 'package:project/Model/Tools/Constant/const.dart';
...
import 'package:project/View/HomeScreen/HomeDetailScreen/detail_screen.dart';
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        return InkWell(
          ...
          child: badge.Badge(
            position: const badge.BadgePosition(end: 0, top: 0),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: badge.Badge(
        ...
        position: const badge.BadgePosition(top: 0, end: 0),
        badgeContent: FavoriteBadge(
          product: product,
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        return badge.Badge(
          ...
          position: const badge.BadgePosition(bottom: 5, end: 10),
