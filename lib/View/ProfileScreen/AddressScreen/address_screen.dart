...
import 'package:project/View/ProfileScreen/AddressScreen/bloc/address_bloc.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:get/get.dart';
import 'package:lottie/lottie.dart';
import 'package:project/ViewModel/Profile/address.dart';
      ...
      create: (context) {
        ...
        subscription = bloc.stream.listen((state) {
          if (state is AddressEditedSuccessfully) {
            snackBar(
                title: "Address",
                message: "Your Address edited Succesfully",
                textStyle: textStyle,
                colors: colors);
          }
        });
